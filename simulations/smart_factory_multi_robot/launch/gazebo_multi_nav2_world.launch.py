...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': '1', 'y_pose': '-3.5', 'z_pose': 0.01},
        {'name': 'tb2', 'x_pose': '2.5', 'y_pose': '-3.5', 'z_pose': 0.01},
        {'name': 'tb3', 'x_pose': '-2', 'y_pose': '-3.5', 'z_pose': 0.01},
        {'name': 'tb4', 'x_pose': '-4', 'y_pose': '-3.5', 'z_pose': 0.01},
        # ...
        # ...
        ]
    ...
    turtlebot3_multi_robot = get_package_share_directory('smart_factory_multi_robot')

    package_dir = get_package_share_directory('smart_factory_multi_robot')
    ...
    world = os.path.join(
        get_package_share_directory('smart_factory_multi_robot'),
        'worlds', 'SmartFactory.world')
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('smart_factory_multi_robot'), 'maps', 'map.yaml'),
                     },],
